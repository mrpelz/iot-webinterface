...
const d = {
  ...
  all: `${s.all} ${p.things}`,
  allCeilingLights: `${s.all} ${s.ceiling} ${p.lights}`,
  allClosed: `${s.all} ${s.closed}`,
  allLights: `${s.all} ${p.lights}`,
  allLightsOff: `${s.all} ${p.lights} ${s.off}`,
  allLightsTimer: `${s.all} ${p.lights} ${s.timer}`,
  allOff: `${s.all} ${s.off}`,
  ...
  enableHallwayStream: `${s.enable} ${s.stream}`,
  enableNotifications: `${s.enable} ${p.notifications}`,
  ...
  kitchenAdjacentLights: `${s.kitchen}-${s.adjacent} ${p.lights}`,
  ...
  nightstandLeds: `${s.night}${s.stand} ${p.leds}`,
  offTimer: `${s.off} ${s.timer}`,
  persistPage: `${s.persist} ${s.page}`,
  r: s.red,
  ...
  workbenchLeds: `${s.workbench}-${p.leds}`,
